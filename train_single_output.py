...
import wandb
from data.preprocess import prepare_inputs_and_targets_predict_JOD_1
...
def load_data(config):
    ...
    dataset = LODFvvdpEccentricityContinous("dataset/example_lod_ecc_white_5_levels", "dataset")
    ...
    train_loader = DataLoader(train_dataset, batch_size=config['batch_size'], shuffle=True, collate_fn=prepare_inputs_and_targets_predict_JOD_1)
    valid_loader = DataLoader(valid_dataset, batch_size=config['batch_size'], shuffle=False, collate_fn=prepare_inputs_and_targets_predict_JOD_1)
...
def load_data_split_by_view(config):
    ...
    dataset = LODFvvdpEccentricityContinous("dataset/example_lod_ecc_white_small", "dataset")
    ...
    print(train_cam_pos)
    print(valid_cam_pos)
    train_dataset = LODFvvdpEccentricityContinous("dataset/example_lod_ecc_white_small", "dataset", camera_position=train_cam_pos)
    valid_dataset = LODFvvdpEccentricityContinous("dataset/example_lod_ecc_white_small", "dataset", camera_position=valid_cam_pos)
...
def load_data_1(config):
    ...
    train_dataset = LODFvvdpEccentricityContinous("dataset/example_lod_ecc_white_small", "dataset")
    valid_dataset = LODFvvdpEccentricityContinous("dataset/example_lod_ecc_white_small_test", "dataset")
...
def main():
    ...
    import os
    wandb.init(project='LODMLPPredictor_HGS', config=config)
